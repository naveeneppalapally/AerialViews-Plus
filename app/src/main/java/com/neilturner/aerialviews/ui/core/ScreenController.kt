...
//                gradientTopView.alpha = 0f
    ...
    private fun updateMetadataOverlayData(media: AerialMedia) {
        val metadataSlots = listOf(OverlayType.METADATA1, OverlayType.METADATA2, OverlayType.METADATA3, OverlayType.METADATA4)
        ...
        when (slot) {
            ...
            OverlayType.METADATA3 -> {
                MetadataResolver.Preferences(
                    ...
                    photoDateType = GeneralPrefs.overlayMetadata3PhotosDateType ?: com.neilturner.aerialviews.models.enums.DateType.COMPACT,
                ...
                MetadataResolver.Preferences(
                    ...
                    photoDateType = GeneralPrefs.overlayMetadata4PhotosDateType ?: com.neilturner.aerialviews.models.enums.DateType.COMPACT,
